...
//**************************************************************************************************
    ...
    AddModel(150, group                            , GetFolder('<b>Inventário</b>'                                               , PATH_LINKS+'M1F7E3071-5210-4C90-BE02-F670B53724AE_Z075.HTML'), false);//LEVEL-ONE-MODEL******************
    AddModel(150, group                            , GetFolder('<b>Inventário Coletor</b>'                                       , PATH_LINKS+'M1BBA6221-3358-40D7-9288-46985D6A07E0_Z075.HTML'), false);//LEVEL-ONE-MODEL******************
...
//GROUP*********************************************************************************************
  group   = AddGroup(foldersTree, GetFolder('<b>Manutenção</b>', 'Welcome.html'), true);
//**************************************************************************************************
ME87F6C7FDDE1495CA1BB820908F74347 = 
    AddModel(150, group                            , GetFolder('<b>Manutenção Corretivas e Emergencial Veiculos e Equip</b>'     , PATH_LINKS+'ME87F6C7F-DDE1-495C-A1BB-820908F74347_Z075.HTML'), true);//LEVEL-ONE-MODEL******************
    AddModel(150, ME87F6C7FDDE1495CA1BB820908F74347, GetFolder('Analizar e planejar Nota de Manutenção e cria ordem de manutenção', PATH_LINKS+'M4E5F294A-34AC-41FE-8088-207AA9DEE71B_Z075.HTML'), false);
    ...
    AddModel(150, ME87F6C7FDDE1495CA1BB820908F74347, GetFolder('Encerramento técnico'                                            , PATH_LINKS+'MFB598E30-25BF-49CC-8657-F2B439CCC8C2_Z075.HTML'), false);
    ...
    AddModel(150, ME87F6C7FDDE1495CA1BB820908F74347, GetFolder('Liberar Ordem de Manutenção'                                     , PATH_LINKS+'M7C5BF97F-03A9-4262-B20D-6B8737D7F873_Z075.HTML'), false);
  M43DF2E91BF9B43E7AED1D2B3996CCEBB = 
    AddModel(150, group                            , GetFolder('<b>Manutenção Preventiva Veiculos e Equip</b>'                   , PATH_LINKS+'M43DF2E91-BF9B-43E7-AED1-D2B3996CCEBB_Z075.HTML'), true);//LEVEL-ONE-MODEL******************
    AddModel(150, M43DF2E91BF9B43E7AED1D2B3996CCEBB, GetFolder('Analisar ordens pendentes de liberação'                          , PATH_LINKS+'M0E79C463-3C81-42C8-BB69-987EF084E152_Z075.HTML'), false);
    AddModel(150, M43DF2E91BF9B43E7AED1D2B3996CCEBB, GetFolder('Criar planos de manutenção'                                      , PATH_LINKS+'M69A26810-0FF7-4355-B0D1-B705F0723833_Z075.HTML'), false);
    AddModel(150, M43DF2E91BF9B43E7AED1D2B3996CCEBB, GetFolder('Encerramento técnico'                                            , PATH_LINKS+'ME1BB11C4-A9B1-46F0-AB36-D2ED98310235_Z075.HTML'), false);
  ...
  M3893284DD15147A1881AD6EFA3F2E667 = 
    ...
    AddModel(150, M3893284DD15147A1881AD6EFA3F2E667, GetFolder('Subcontratação ( Terceiro )'                                     , PATH_LINKS+'M3AC9D0B5-52BE-4D45-A9AA-757A1053C713_Z075.HTML'), false);
    AddModel(150, M3893284DD15147A1881AD6EFA3F2E667, GetFolder('Transporte Próprio'                                              , PATH_LINKS+'MBD9D6948-7F67-4D87-AC99-1013531A4338_Z075.HTML'), false);
  M5EEBE5A65565489BA42DD77B8A892B16 = 
    AddModel(150, group                            , GetFolder('<b>NF Transferência</b>'                                         , PATH_LINKS+'M5EEBE5A6-5565-489B-A42D-D77B8A892B16_Z075.HTML'), true);//LEVEL-ONE-MODEL******************
...
//**************************************************************************************************
  M755A1D4B5DD848B08ED6401F8B0847E9 = 
    AddModel(150, group                            , GetFolder('<b>CARGA INTERFÁBRICA</b>'                                       , PATH_LINKS+'M755A1D4B-5DD8-48B0-8ED6-401F8B0847E9_Z075.HTML'), true);//LEVEL-ONE-MODEL******************
  ...
  M80E5D1A7BEE141E3B1E22DFD2EA4C216 = 
    ...
    AddModel(150, M80E5D1A7BEE141E3B1E22DFD2EA4C216, GetFolder('Atender ordem de frete ( subcontratação )'                       , PATH_LINKS+'MC7D03286-477D-497A-B303-8B8D0D0029AD_Z075.HTML'), false);
  ...
  MEA06A46287764F2898C44C9572E2A7C6 = 
    ...
    AddModel(150, MEA06A46287764F2898C44C9572E2A7C6, GetFolder('Atender ordem de frete ( subcontratação )'                       , PATH_LINKS+'MAF0FE55B-1BD7-455A-BE6F-E5573CFC9B2E_Z075.HTML'), false);
    AddModel(150, MEA06A46287764F2898C44C9572E2A7C6, GetFolder('Lançar CTE'                                                      , PATH_LINKS+'M6DD68866-8100-47EA-A420-D00ABD50A9A2_Z075.HTML'), false);
  ...
  M418F35F2D5514D778FADB92CA8B83861 = 
    AddModel(150, group                            , GetFolder('<b>Coletas Importação</b>'                                       , PATH_LINKS+'M418F35F2-D551-4D77-8FAD-B92CA8B83861_Z075.HTML'), true);//LEVEL-ONE-MODEL******************
  ...
  M5360B03CE19549B7A11383154ECE5341 = 
    ...
    AddModel(150, M5360B03CE19549B7A11383154ECE5341, GetFolder('Atender ordem de frete ( subcontratação )'                       , PATH_LINKS+'MF41BED3D-D0A4-4576-B61D-1B463A9F6F82_Z075.HTML'), false);
    AddModel(150, M5360B03CE19549B7A11383154ECE5341, GetFolder('Lançar CTE'                                                      , PATH_LINKS+'MFF3D8345-B194-4DFF-9E89-A97231FDFD7E_Z075.HTML'), false);
  ...
  MA187231402474BC2A865A58593FBC2E4 = 
    AddModel(150, group                            , GetFolder('<b>Licenças de Transporte</b>'                                   , PATH_LINKS+'MA1872314-0247-4BC2-A865-A58593FBC2E4_Z075.HTML'), true);//LEVEL-ONE-MODEL******************
    AddModel(150, MA187231402474BC2A865A58593FBC2E4, GetFolder('Licença Carga Excedente'                                         , PATH_LINKS+'M916ED476-804C-437A-AD4F-46F3A46278F4_Z075.HTML'), false);
    AddModel(150, MA187231402474BC2A865A58593FBC2E4, GetFolder('Licença Produto Novo'                                            , PATH_LINKS+'ME44526E9-A016-49F4-BB42-16953C607422_Z075.HTML'), false);
    AddModel(150, group                            , GetFolder('<b>Prestação de contas Veiculos Sem NF</b>'                      , PATH_LINKS+'M3467E64E-323F-4256-98C9-308CA3AAA239_Z075.HTML'), false);//LEVEL-ONE-MODEL******************
    AddModel(150, group                            , GetFolder('<b>Prestação de contas Viagem</b>'                               , PATH_LINKS+'M884CCE6B-2D18-4A45-A09F-2A092B0EA770_Z075.HTML'), false);//LEVEL-ONE-MODEL******************
