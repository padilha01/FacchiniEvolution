...
function Folder(folderDescription, hreference) //constructor
{
  ...
  this.iconImg = 0;
  this.nodeImg = 0;
  this.iconSrc = PATH_ICONS       + 'Project_Open.png';
  this.iconSrcClosed = PATH_ICONS + 'Project_Close.png';
...
function drawFolder(insertAtObj)
{
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
     leftSide = leftSide + "<td valign=top>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></a></td>";
      ...
      leftSide = leftSide + "<td valign=top background=" + PATH_ICONS + "Explorer_Line_Vertical.png>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></a></td>";
  ...
  {
   if (this.prependHTML == '') 
     docW = docW + "<img src=" + PATH_ICONS + "Explorer_Temp_Empty.png height='2' width='2'>";
  }
...
function linkFolderHTML(isTextLink)
{
  ...
  {
   if (USEFRAMES)
     docW = docW + "<a href='" + this.hreference + "' target=\"FRAME_PROCESS\" ";
   else
...
function nodeImageSrc()
{
  ...
  {
    if (this.nChildren == 0)
      srcStr = PATH_ICONS   + "Explorer_Line_Edge2.png";
    else
      if (this.isOpen)
        srcStr = PATH_ICONS + "Explorer_Node_Minus2.png";
      else
        srcStr = PATH_ICONS + "Explorer_Node_Plus2.png";
  } 
  else 
  { 
    if (this.nChildren == 0)
      srcStr = PATH_ICONS   + "Explorer_Line_Edge1.png";
    else
      if (this.isOpen)
        srcStr = PATH_ICONS + "Explorer_Node_Minus1.png";
      else
        srcStr = PATH_ICONS + "Explorer_Node_Plus1.png";
  }   
  return srcStr;
}
...
function finalizeCreationOfItem(itemArray)
{
  ...
  itemArray.iconSrc = PATH_ICONS + "Explorer_Temp_Dummy.png";
...
function drawItem(insertAtObj)
{
  ...
  if (this.level>0)
    ...
    {
      leftSide = leftSide + "<td valign=top><img src='" + PATH_ICONS + "Explorer_Line_Edge2.png' width='16' height='22'></td>";
    }
    else
    {
      leftSide = leftSide + "<td valign=top background=" + PATH_ICONS + "Explorer_Line_Vertical.png><img src='" + PATH_ICONS + "Explorer_Line_Edge1.png' width='16' height='22'></td>";
    }
  ...
  if (USEICONS)
   ...
   if (this.prependHTML == '')
        docW = docW + "<img src=" + PATH_ICONS + "Explorer_Temp_Empty.png height='2' width='3'>";
...
function leftSideHTML(leftSideCoded)
{
 ...
 for (i=0; i<leftSideCoded.length; i++)
 {
  ...
  {
   retStr = retStr + "<td valign=top background=" + PATH_ICONS + "Explorer_Line_Vertical.png><img src='" + PATH_ICONS + "Explorer_Line_Vertical.png' width='16' height='22'></td>";
  }
  if (leftSideCoded.charAt(i) == "0")
  {
   retStr = retStr + "<td valign=top><img src='"  + PATH_ICONS + "Explorer_Temp_Empty.png' width='16' height='22'></td>";
  }
 }
 return retStr;
}
...
//************************************************************************
function AddGroup(parentFolder, childFolder, hasChild)
{
  newGroup = parentFolder.addChild(childFolder);
  if (hasChild)
  {
    newGroup.iconSrc     = PATH_ICONS + "Group_Open.png";
  }
  else
  {
    newGroup.iconSrc     = PATH_ICONS + "Group_Close.png";
  }
  newGroup.iconSrcClosed = PATH_ICONS + "Group_Close.png";
  return newGroup;
}

//************************************************************************
function AddModel(pModelType, parentFolder, childFolder, hasChild)
{
  newModel = parentFolder.addChild(childFolder);
  if (hasChild)
  {
    newModel.iconSrc     = PATH_ICONS + "Model_" + pModelType + "_Open.png";
  }
  else
  {
    newModel.iconSrc     = PATH_ICONS + "Model_" + pModelType + "_Close.png";
  }
  newModel.iconSrcClosed = PATH_ICONS + "Model_" + pModelType + "_Close.png";
  return newModel;
}
...
function preLoadIcons()
{
  ...
  (
    "Explorer_Line_Vertical.png",
    "Explorer_Node_Minus2.png",
    "Explorer_Node_Minus1.png",
    "Explorer_Node_Plus2.png",
    "Explorer_Node_Plus1.png",
    "Explorer_Temp_Empty.png",
    "Explorer_Line_Edge2.png",
    "Explorer_Line_Edge1.png",
    "Project_Close.png",
    "Project_Open.png",
    "Explorer_Temp_Dummy.png"
  );
